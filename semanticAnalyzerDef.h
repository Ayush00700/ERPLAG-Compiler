...
typedef enum semErrors{
    ...
    RECURSION_NOT_ALLOWED ,PARAMETER_LIST_MISMATCH, DEFAULT_NOT_FOUND,
     DEFAULT_FOUND, INDEX_OUT_OF_BOUNDS, VAR_REDECLARED,VALUE_MODIFIED, 
     VALUE_NOT_MODIFIED,FUNCTION_NOT_DEFINED, FUNCTION_OVERLOADING
     ,PARAMETER_LIST_MISMATCH_LEN, OUTPUT_REDECLARED, INVALID_MODULE_ASSIGNMENT
} semErrors;
