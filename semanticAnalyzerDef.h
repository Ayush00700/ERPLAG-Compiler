...
typedef enum semErrors{
    ...
    UNSUPPORTED_DTYPE,FUNC_NOT_DEFINED, OUT_OF_ORDER_INDEX,RECURSION_NOT_ALLOWED
    ,PARAMETER_LIST_MISMATCH, DEFAULT_NOT_FOUND, DEFAULT_FOUND, INDEX_OUT_OF_BOUNDS
} semErrors;
