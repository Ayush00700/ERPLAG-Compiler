...
int main(int argc, char* args[]){ //DRIVER
    ...
    printf("Level 4 of Type checking was achieved\n");
    printf("Symbol table/AST/semantic rules work fine\n");
    printf("Intermediate code generation is working fine\n\n");
    ...
    populate_hash_table();
    call_lexer(fp,bufferSize); //TODO VARIABLE ARG
        ...
        switch (choice)
        {
            ...
            case 9:
            {
                if(LEXICAL_ERRORS){
                    ...
                    printf("\nAssembly code is saved in file ((code.asm))\n");
