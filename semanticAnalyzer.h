...
extern void func_act_printer(var_record* node);
extern void print_activation();
extern void print_ipop_list_sda(sym_tab_entry* list,int level,var_record* record);
extern void print_level_sda(var_record* node,int level);
extern void printer_sda(func_entry* node);
extern void print_static_dynamic_arrays();
...
extern type_exp* find_in_list(sym_tab_entry* output,char* key);
